...
PPI_Suppinterpro_df <- plot_df

save(PPI_Suppinterpro_df, file = paste0("./03_OutputFiles/",gsub("-","",Sys.Date()),"_PPI_Suppinterpro_df.RData"))
...
if (interaction == "PPI") {
  ...
  RNA_filter <- c("PF00571","PF00478","PS51371","PF00025","SM00116","SM01240","SSF54631","SSF51412")
...
PPI_interpro_df <- plot_df

save(PPI_interpro_df, file = paste0("./03_OutputFiles/",gsub("-","",Sys.Date()),"_PPI_interpro_df.RData"))
